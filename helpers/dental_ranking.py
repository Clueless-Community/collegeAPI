...
url = "https://www.nirfindia.org/2022/DentalRanking.html"
...
dental_ranking = json.dumps(parsed, indent=4)

# Writing the json formatted data to a file
with open("./data/dental_ranking.json", "w") as f:
    f.write(dental_ranking)
    f.close()
