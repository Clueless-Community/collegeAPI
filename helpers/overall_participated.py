# Participated Institutes: Overall
...
overall_participated = json.dumps(parsed, indent=4)

# Writing the json formatted data to a file
with open("./data/overall_participated.json", "w") as f:
    f.write(overall_participated)
    f.close()
