...
url = "https://www.nirfindia.org/2022/CollegeRanking.html"
...
college_ranking = json.dumps(parsed, indent=4)

# Writing the json formatted data to a file
with open("./data/college_ranking.json", "w") as f:
    f.write(college_ranking)
    f.close()
