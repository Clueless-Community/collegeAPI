# Participated Institutes: College

import pandas as pd
import json

url = "https://www.nirfindia.org/2022/CollegeRankingALL.html"
...
with open("./data/college_participated.json", "w") as f:
    f.write(college_participated)
    f.close()
