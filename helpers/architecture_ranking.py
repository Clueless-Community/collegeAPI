...
url = "https://www.nirfindia.org/2022/ArchitectureRanking.html"
...
architecture_ranking = json.dumps(parsed, indent=4)

# Writing the json formatted data to a file
with open("./data/architecture_ranking.json", "w") as f:
    f.write(architecture_ranking)
    f.close()
